  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .bg-tema5.p-5.mn.pb-2
        ...
        .col-lg-7.mb-lg-0.mb-3(data-aos="fade-right")
          ...
          ul.lista-ul--color
            li.d-flex
              ...
              p.mb-0 Se inicia, entonces, con la creación del archivo dentro de la carpeta, continuando con la creada en el punto anterior, para tener una continuidad sobre el trabajo realizado.
      ...
      ul.lista-ul--color
        li.d-flex
          i.fas.fa-square(style="color: #221b6b")
          p.mb-0 En el archivo se empiezan a crear las modificaciones que sufrirá el archivo HTML con respecto a los estilos que se desean que se cambien en el mismo. Es importante tener en cuenta que todo lo que se cambie en los objetos en HTML está relacionado directamente con los comandos ejecutados en el archivo CSS.
      .row.justify-content-center.mb-5
        .col-lg-8
          .titulo-sexto.color-acento-contenido(data-aos='fade-right')
            h5 Figura 5
      ...
      ul.lista-ul--color
        li.d-flex
          i.fas.fa-square(style="color: #221b6b")
          p.mb-0 Por último, se crea la relación entre el archivo .css y el documento de HTML para que todos los cambios que se realicen en el archivo .css afecten directamente al documento HTML; de lo contrario, no se podrán visualizar los cambios de manera correcta.
      .row.justify-content-center.mb-5
        .col-lg-8
          .titulo-sexto.color-acento-contenido(data-aos='fade-right')
            h5 Figura 6
...
.bg-card1
  ...
  position: relative
  &:before
    content: url('../assets/curso/temas/icon2.svg')
    position: absolute
    top: 0
    left: -50px
